...
public class CreateSizeDIR{
	...
	public boolean createFolder(long fileSize,int accuracy) throws IOException{
		long fs = fileSize;
		long one;
		long two;
		long three;
	...
	public static void main(String[] args) throws IOException{
		CreateSizeDIR ctd = new CreateSizeDIR();
		ctd.createFolder(7*100*1024*1024+8*1024*1024+9*10*1024+1000, 4);
	}
}